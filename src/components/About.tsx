    ...
    <section className="container mx-auto my-4 max-w-5xl p-4">
      ...
      <div className="relative mx-auto mt-20 max-w-lg">
        <div className="relative w-full rounded-lg bg-blue-100 p-4 ps-20 md:h-64 md:ps-48">
            ...
            <table className="mt-4 w-full text-sm">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="mailto:vitormarinheiro9@gmail.com"
                      className="underline hover:text-blue-800"
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="https://www.google.com/maps/place/Osasco,+SP/@-23.5347434,-46.8257732,13z/data=!3m1!4b1!4m6!3m5!1s0x94ceff085b9ef207:0xf21e27d4c824c4e!8m2!3d-23.5318198!4d-46.7916315!16s%2Fg%2F122n5xvw?entry=ttu"
                      target="_blank"
                      className="underline hover:text-blue-800"
                    >
                      Osasco, SP
          ...
          <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-[url(../src/assets/me.jpeg)] bg-cover bg-center md:-left-12 md:-top12 md:h-72 md:w-56"></div>
        </div>
      </div>
    </section>
  );
